$(function () {
	...
	var h = document.body.clientHeight-$('.header').height()-6;
    console.log(h)
    $('.container').height(h);
    $('.map').height(h);
    map();
...
//      获取元素
          ...
          common.ajaxPost(
  	    		common.getCtx() + "/mians/tjnums.do", 
  			    		{
  			             "userName": "8888"
  			            }, 
  	        function (result) { 
      	        if (result.success) {
      	        	  var allnums1=result.data.alldatanums;
      	        	  var addnums=result.data.curraddnums;
          	...
          	common.ajaxPost(
      	        ...
      	        function (result) { 
          	        if (result.success) {
        	        	  ...
        	        	  var toalnum2 = toalnum.substring(1);
        	        	  var toalnum3 = toalnum1 + " " + "," + toalnum2;
          	        	  //alert("addnums:"+addnums+"---------allnums1:"+allnums1);
          	        	  $('.total>div:eq(0)').text(toalnum3);
          	              var  num0 =  splists(addnums,1);
          	              $(timebox[0]).text(parseInt(num0));
          	              var  num1 = splists(addnums,2);
