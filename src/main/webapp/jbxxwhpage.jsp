                    ...
                    <li data-index="1" style="display: none;">
                        <div class="normal-inner">
                            <div class="cloud-product-single-bottom clearfix">
                                ...
                                <h2 class="product-introduce-title">基本信息维护</h2>
                                <div class="product-introduce-list">
                                    <p class="introduce-list-small"><input type="button" class="btnlist"  name="menus" id="grxxwhcp"  value="个人信息维护"/></p>
                                    <p class="introduce-list-small"><input type="button" class="btnlist"  name="menus" id="cshbdbscp"  value="初始化表底报送"/></p>
                                </div>
                        ...
                        <div class="active-inner active-inner-02 clearfix">
                            <div class="active-inner-item">
                                ...
                                <h2 class="product-introduce-title active-product-introduce-title ">基本信息维护</h2>
                                <div class="product-introduce-list">
                                    <p class="introduce-list-small"><input type="button" class="btnlist"  name="menus" id="grxxwh"  value="个人信息维护"/></p>
                                    </p>
                                    <p class="introduce-list-small"><input type="button" class="btnlist"  name="menus" id="cshbdbs"  value="初始化表底报送"/></p>
                                    </p>
                                </div>
                                <p class="product-introduce-price">
                                    基本信息维护...
