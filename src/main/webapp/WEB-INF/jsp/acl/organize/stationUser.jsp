...
<div class="easyui-layout" style="width:100%;height:100%;">
    ...
    <div region="center" border="false" style="padding:0;height:300px;">
...
<script>
    ...
    function addUser() {
        ...
        var $win = $.TS.window.getWindow({
            ...
            'width': 800,
            'height': 400,
            'href': '${pageContext.request.contextPath}/acl/organize/userAdd?orgId=${param.orgId}&stationId=' + row.stationId
        });
    }
    ...
    function removeUser() {
        ...
        $.TS.messager.confirm('删除确认', '是否删除岗位拥有的用户?', function (data) {
            if (data) {
                var paramData = {'orgId': '${param.orgId}', 'stationId': row.stationId};
