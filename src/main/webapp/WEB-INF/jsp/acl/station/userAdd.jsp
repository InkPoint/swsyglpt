...
<script>
    $(function() {
        $('#userGrid').datagrid({
            ...
            pageSize : 10,
            border : true,
            url : '${pageContext.request.contextPath}/acl/role/getNotOwnUsers?roleId=${param.roleId}'
        });
    });
    ...
    function saveOwnUser() {
        ...
        var gridData = $.TS.genDataGridParam('#userGrid','userList','selected');
        $.extend(paramData,gridData);   // 将grid数据添加到paramData数据参数中
        $.ajax({
            url: '${pageContext.request.contextPath}/acl/role/addOwnUser',
            type: 'post',
            data: paramData,
