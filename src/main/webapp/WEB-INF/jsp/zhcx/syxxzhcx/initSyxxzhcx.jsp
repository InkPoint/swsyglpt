...
<div style="width: 98%; margin:10px auto 0px auto;">
    <div class="row">
        ...
        <div class="col-md-6">   <div class="panel panel-default">
            <div class="panel-heading">用水量税款趋势</div>
...
<script>
    ...
    function tbhbtEcharts(obj){
        ...
        $.post("${ctx}/zhcx/syxxzhcx/skjnjetbhbQuery",param , function (result) {
            option.series[0].data=[result.CURRSKJNJE1Q, result.CURRSKJNJE2Q, result.CURRSKJNJE3Q, result.CURRSKJNJE4Q];
    ...
    function sylxysltEcharts(obj){
        ...
        $.post("${ctx}/zhcx/syxxzhcx/sksylxQuery", getparam(), function (result) {
            for (var a in result){
                option.series[0].data.push({"value":result[a].SKJNJE,"name":result[a].SYLXMC});
    ...
    function hyyslfbtEcharts(obj){
        ...
        $.post("${ctx}/zhcx/syxxzhcx/skhyQuery", getparam(), function (result) {
            for (var a in result){
                option.series[0].data.push({"value":result[a].SKJNJE,"name":result[a].QYSHYMC});
    ...
    function dxsccqlxyslzbEcharts(obj){
        ...
        $.post("${ctx}/zhcx/syxxzhcx/skdxsccqlxQuery", getparam(), function (result) {
            for (var a in result){
                option.series[0].data.push({"value":result[a].SKJNJE,"name":result[a].DXSCCQLXMC});
    ...
    function tsyslxyslzbEcharts(obj){
        ...
        $.post("${ctx}/zhcx/syxxzhcx/sktsyslxQuery", getparam(), function (result) {
            for (var a in result){
                option.series[0].data.push({"value":result[a].SKJNJE,"name":result[a].TSYSLBMC});
    ...
    function nyslqstEcharts(obj){
        ...
        $.post("${ctx}/zhcx/syxxzhcx/skjnjeqsQuery", getparam(), function (result) {
            for (var a in result){
                option.series[0].data.push(result[a].SKJNJE);
                option.xAxis.data.push(result[a].YSNF);
                option.series[1].data.push(result[a].SKJNJE);
