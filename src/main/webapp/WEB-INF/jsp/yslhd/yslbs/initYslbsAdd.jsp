...
<table class="table table-bordered table-striped" style="width: 98%; margin:20px auto;">
    ...
    <tbody>
         <tr>
             <td>水行政主管部门:</td>
             <td><input type="text" id="${sxzzgbm}" name="sxzzgbm" value="${sxzzgmc}" class="form-control" disabled></td>
             <td>取水所属期起:</td>
             <td>
        ...
        <tr>
            <td>联系人:</td>
            <td><input type="text" id="lxr" name="bsyxm" value="${bsyxm}"  class="form-control"></td>
            <td>联系方式:</td>
            <td><input type="text" id="lxfs" name="bsylxdh" value="${bsylxdh}" class="form-control" maxlength="11"></td>
            <td>水源类型:</td>
         ...
         <tr>
             <td>水源区域:</td>
             <td><input type="text" id="${syqy}" name="syqysmc" value="${syqysmc}" class="form-control" disabled></td>
             <td>特殊用水类别:</td>
             <td><input type="text" id="${tsyslb}" name="tsyslb" value="${syqysmc}"  class="form-control" disabled></td>
             <td>地下水超采区类型:</td>
...
<script>
    ...
    function inittabs() {
        ...
        $('#mytab').bootstrapTable({
            url: "${ctx}/yslhd/yslbs/getBsmx",//获取数据的Select地址
...
//            },
            columns: [
...

                {
                    ...
                    formatter:function(value, row, index, field){
                        return '<input type="text"  name="sqbds" class="form-control" >';
                    }
                    ...
                    title: '本期表底数',
                    formatter:function(value, row, index, field){
                        return '<input type="text"  name="bqbds" class="form-control" >';
                    }
                }, {
                    field: 'bqqsl',
                    align: 'right',
                    ...
                    title: '本期取水量',
                    formatter:function(value, row, index, field){
                        return '<input type="text"  name="bqqsl" class="form-control" >';
                    }
                }, {
                    field: 'ljqsl',
                    align: 'right',
                    ...
                    title: '累计取水量',
                    formatter:function(value, row, index, field){
                        return '<input type="text"  name="ljqsl" class="form-control" >';
                    }
                }, {
                    field: 'jhqsl',
                    align: 'right',
                    ...
                    title: '计划取水量',
                    formatter:function(value, row, index, field){
                        return '<input type="text"  name="jhqsl" class="form-control" >';
                    }
                }, {
                    field: 'hddjhnqsl',
                    align: 'right',
                    ...
                    title: '核定的计划内取水量',
                    formatter:function(value, row, index, field){
                        return '<input type="text"  name="hddjhnqsl" class="form-control" >';
                    }
                }, {
                    field: 'hddcjhqsl',
                    align: 'right',
                    ...
                    title: '核定的超计划取水量',
                    formatter:function(value, row, index, field){
                        return '<input type="text"  name="hddcjhqsl" class="form-control" >';
                    }
                }
                ,{
                    field: 'fileurl',
                    ...
                    title: '附件url',
                    formatter:function(value, row, index, field){
                        return '<input type="text" name="fileurl" class="form-control" disabled >';
                    }
                }
                , {
                    field: 'cz',
    ...
    function saves() {
       ...
       // console.log(JSON.stringify(dataArr));
        ...
        //提交url
        var myurl = "${ctx}/yslhd/yslbs/newaddition";
        //成功方法
        $.ajax({
