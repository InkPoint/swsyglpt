...
<form id="tablevalidation" method="post" class="form-horizontal">
    <table class="table table-bordered table-striped" style="width: 98%; margin:35px auto;">
        ...
        <tr>
            <td>登记序号:</td>
            <td colspan="3"><input type="text" id="djxh" name="djxh" class="form-control" required="true"></td>
            <td>纳税人识别号</td>:</td>
            <td colspan="3"><input type="text" id="nsrsbh" name="nsrsbh" class="form-control"></td>
        </tr>
        <tr>
            <td>纳税人名称:</td>
            <td colspan="3"><input type="text" id="nsrmc" name="nsrmc" class="form-control"></td>
            <td>电子税票号码</td>:</td>
            <td colspan="3"><input type="text" id="dzsphm" name="dzsphm" class="form-control"></td>
        </tr>
        <tr>
            <td>税款所属期期起:</td>
            <td colspan="3">
        ...
        <tr>
            <td>税款缴纳金额:</td>
            <td colspan="3"><input type="text" id="skjnje" name="skjnje" class="form-control" required="true"></td>
            <td>核查税款金额</td>:</td>
...
<script>
    ...
    $(function(){
        $.ajax({
            ...
            url: '${ctx}/skxx/skxxfk/doFkxxInit',
            data: {'hdsbh':hdsbh},
            type:'post',
            dataType:'json',
            success: function(json){
                    ...
                    //税款缴纳金额
                    $("#skjnje").val(parseFloat(json[0].SKJNJE).toFixed(2));
                    //反馈人
                   // $("#fkr").val(json[0].FKR);
                    //反馈时间
    ...
    function saves() {
       ...
       // var fkr = $("#fkr").val();
        ...
        //提交url
        var myurl = "${ctx}/skxx/skxxfk/doFkxxEdit";
        //成功方法
        $.ajax({
            contentType : 'application/x-www-form-urlencoded; charset=UTF-8',
            url: myurl,
