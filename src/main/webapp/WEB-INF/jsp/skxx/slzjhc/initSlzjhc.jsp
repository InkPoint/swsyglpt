...
<table  class="table table-bordered table-striped" style="width: 98%; margin:0px auto;">
    ...
    <tr>
        <td colspan="2">
            <a  href ="#">
                <button id="hc" type="button" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-plus"></i>核查</button>
            </a>
        </td>
    </tr>
    </tbody>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#hc").click(function(){
            ...
            var hdsbh
            if (rows.length == 0) {
                layer.alert("请选择要核查的数据！");
                return;
            } else {
                window.location.href = "${ctx}/skxx/slzjhc/ylszjhc?hdsbh=" + rows[0].hdsbh;
            }
        });
    });
    ...
    function inittabs(nsrsbh, nsrmc) {
        ...
        $('#taskList_table').bootstrapTable({
            url: "${ctx}/skxx/slzjhc/selectAll",//获取数据的Select地址
